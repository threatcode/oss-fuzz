...
[json-sanitizer](https://github.com/threatcode/oss-fuzz/tree/master/projects/json-sanitizer)
...
[java-example](https://github.com/threatcode/oss-fuzz/tree/master/projects/java-example)
project.
...
The [java-example](https://github.com/threatcode/oss-fuzz/blob/master/projects/java-example/build.sh)
