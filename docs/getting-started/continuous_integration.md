...
1. Copy the example [`cifuzz.yml`](https://github.com/threatcode/oss-fuzz/blob/master/infra/cifuzz/example_cifuzz.yml)
...
is the name of your project's subdirectory in the [`projects`](https://github.com/threatcode/oss-fuzz/tree/master/projects) directory of OSS-Fuzz.
...
jobs:
 Fuzzing:
   ...
   - name: Build Fuzzers
     id: build
     uses: threatcode/oss-fuzz/infra/cifuzz/actions/build_fuzzers@master
     with:
       oss-fuzz-project-name: 'example'
       language: c++
   - name: Run Fuzzers
     uses: threatcode/oss-fuzz/infra/cifuzz/actions/run_fuzzers@master
     with:
       oss-fuzz-project-name: 'example'
       language: c++
       fuzz-seconds: 600
...
Create an issue in [OSS-Fuzz](https://github.com/threatcode/oss-fuzz/issues/new) if you have questions or any other feedback on CIFuzz.
