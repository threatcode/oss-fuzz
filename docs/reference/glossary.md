...
(example: [expat](https://github.com/threatcode/oss-fuzz/tree/master/projects/expat))
...
Compiler flag values for predefined configurations are specified in the [Dockerfile](https://github.com/threatcode/oss-fuzz/blob/master/infra/base-images/base-builder/Dockerfile). 
These flags can be overridden by specifying `$SANITIZER_FLAGS` directly.

You can choose which configurations to automatically run your fuzzers with in `project.yaml` file (e.g. [sqlite3](https://github.com/threatcode/oss-fuzz/tree/master/projects/sqlite3/project.yaml)).
