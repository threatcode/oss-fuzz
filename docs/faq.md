...
You should look for places in your code that:
  ...
  - look for existing fuzz target [examples](https://github.com/threatcode/oss-fuzz/tree/master/projects)
...
[OSS-Fuzz repository]: https://github.com/threatcode/oss-fuzz
