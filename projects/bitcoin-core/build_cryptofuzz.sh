...
# Build Cryptofuzz
cd $SRC/cryptofuzz
( # Temporary workaround for clang-15 bug, see https://github.com/threatcode/oss-fuzz/pull/8313#issuecomment-1223234359
...
# Discussion: https://github.com/threatcode/oss-fuzz/pull/5717#issuecomment-842765383
